...
query = "Killer"
query = {"input": query}
chain = rag_chain | qa_chain
result = chain.invoke(query)

print(result)
# qa_chain = create_stuff_documents_chain(llm, prompt)  # prompt and llm used inside here

# chain = retriever | qa_chain  # pipe retriever output to QA chain

# result = chain.invoke({"input": "Killer"})
# print(result["answer"])
